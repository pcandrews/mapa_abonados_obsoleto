...
LOAD DATA LOCAL INFILE '/home/pablo/20160830.csv'
...
/*Extra*/
/**
 * 	Cantidad de numeros_abonado diferentes.
 */

SELECT COUNT(DISTINCT `numero_abonado`) FROM `csv_app_relevamiento`
