...
SOLO EESTAS BORRAR LAS DEMAS

***

CREATE TABLE IF NOT EXISTS app_mapa_abonados.abonados (
id_mae_abonados INT (11) NOT NULL AUTO_INCREMENT UNIQUE,
...
LOAD DATA LOCAL INFILE '{$archivos_csv[$i]}'
	INTO TABLE app_mapa_abonados.abonados FIELDS TERMINATED BY '\",'
	LINES TERMINATED BY '\\n'
...
ruta_archivo_csv VARCHAR(255),
ruta_archivo_kml VARCHAR (255),
fecha_instalacion DATETIME,
año_instalacion DATETIME,
mes_instalacion DATETIME,
dia_instalacion DATETIME,
fecha_y_hora_instalacion DATETIME,
FOREIGN KEY (id_ref_abonados) REFERENCES app_mapa_abonados.abonados (id_mae_abonados)
...
LOAD DATA LOCAL INFILE '{$archivos_csv[$i]}'
	INTO TABLE app_mapa_abonados.instalaciones FIELDS TERMINATED BY '\",' 
	LINES TERMINATED BY '\\n' 
...
UPDATE app_mapa_abonados.instalaciones JOIN app_mapa_abonados.abonados ON app_mapa_abonados.instalaciones.numero_abonado = app_mapa_abonados.abonados.numero_abonado SET app_mapa_abonados.instalaciones.id_ref_abonados = app_mapa_abonados.abonados.id_mae_abonados WHERE instalaciones.id_ref_abonados is NULL
***

CREATE TABLE IF NOT EXISTS app_mapa_abonados.fotos (
id INT (11) NOT NULL AUTO_INCREMENT UNIQUE,
id_ref_abonados INT (11),
numero_abonado INT(11),
...
CREATE TABLE IF NOT EXISTS app_mapa_abonados._temp_csv (
id INT (11) NOT NULL AUTO_INCREMENT UNIQUE,
numero_abonado INT(11),
punto_gps_string VARCHAR(255),
lat_abonado DOUBLE DEFAULT 0,
...
dia_instalacion DATETIME,
fecha_y_hora_instalacion DATETIME,
ruta_original_archivo_csv VARCHAR(255),
ruta_destino_archivo_csv VARCHAR(255),
PRIMARY KEY(id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 DEFAULT COLLATE=utf8_spanish_ci;
CREATE TABLE IF NOT EXISTS app_mapa_abonados._temp_kml (
id INT (11) NOT NULL AUTO_INCREMENT UNIQUE,
numero_abonado INT(11),
ruta_original_archivo_kml VARCHAR (255),
ruta_destino_archivo_kml VARCHAR (255),
PRIMARY KEY(id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 DEFAULT COLLATE=utf8_spanish_ci;
CREATE TABLE IF NOT EXISTS app_mapa_abonados._temp_foto (
id INT (11) NOT NULL AUTO_INCREMENT UNIQUE,
numero_abonado INT(11),
ruta_original_archivo_foto VARCHAR(255),
ruta_destino_archivo_foto VARCHAR(255),
PRIMARY KEY(id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 DEFAULT COLLATE=utf8_spanish_ci
